...
public class UC { //UniversalConstants
    ...
    public static final int noMatchDis = 5000000;
    ...
    public static final int barTooMarginSnap = 20;
    ...
    public static final int initialClefOffset = 50;
}
